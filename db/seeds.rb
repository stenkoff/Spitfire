...
Track.create(title: 'Same Drugs', album_id: cb.id, ord: 6, audio: 'https://s3.amazonaws.com/spitfire-dev/tracks/audios/06_Same_Drugs.m4a')
...
Track.create(title: "Wesley's Theory", album_id: tpab.id, ord: 1, audio: "https://s3.amazonaws.com/spitfire-dev/tracks/01_Wesley's+Theory.mp3")
...
Track.create(title: 'Institutionalized', album_id: tpab.id, ord: 4, audio: 'https://s3.amazonaws.com/spitfire-dev/tracks/04_Institutionalized.mp3')
