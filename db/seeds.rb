...
Track.create!(title: 'Same Drugs', album_id: cb.id, ord: 6, audio: "http://s3.amazonaws.com/spitfire-dev/tracks/audios/000/000/229/original/06_Same_Drugs.m4a?1498748074")
...
Track.create!(title: "Wesley's Theory", album_id: tpab.id, ord: 1, audio: "http://s3.amazonaws.com/spitfire-dev/tracks/audios/000/000/228/original/01_Wesley's_Theory.mp3?1498747471")
...
Track.create!(title: 'Institutionalized', album_id: tpab.id, ord: 4, audio: "http://s3.amazonaws.com/spitfire-dev/tracks/audios/000/000/230/original/04_Institutionalized.mp3?1498748166")
