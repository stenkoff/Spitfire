...
Track.create!(title: 'All We Got', album_id: cb.id, ord: 1, audio: File.open("app/assets/tracks/coloring_book/01 All We Got (feat. Kanye West & Chicago Children's Choir).m4a"))
