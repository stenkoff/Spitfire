...
quest = Artist.create!(name: 'A Tribe Called Quest', image: File.open("app/assets/images/tribe_called_quest.jpg"))
we_got_it = Album.create!(name: 'We got it from Here... Thank You 4 Your service', artist_id: quest.id, image: File.open('app/assets/images/we_got_it.jpg'))

Track.create!(title: "The Space Program", album_id: we_got_it.id, ord: 1, audio: "http://s3.amazonaws.com/spitfire-dev/tracks/audios/000/000/358/original/ATribeCalledQuest_WeGotItFromHereThankYou4YourService_TheSpaceProgram_1.mp3")
Track.create!(title: "We The People....", album_id: we_got_it.id, ord: 2, audio: "http://s3.amazonaws.com/spitfire-dev/tracks/audios/000/000/359/original/ATribeCalledQuest_WeGotItFromHereThankYou4YourService_WeThePeople_2.mp3")
Track.create!(title: "Whateva Will Be", album_id: we_got_it.id, ord: 3, audio: "http://s3.amazonaws.com/spitfire-dev/tracks/audios/000/000/360/original/ATribeCalledQuest_WeGotItFromHereThankYou4YourService_WhatevaWillBe_3.mp3")
Track.create!(title: "Solid Wall of Sound", album_id: we_got_it.id, ord: 4, audio: "http://s3.amazonaws.com/spitfire-dev/tracks/audios/000/000/361/original/ATribeCalledQuest_WeGotItFromHereThankYou4YourService_SolidWallOfSound_4.mp3")
Track.create!(title: "Dis Generation", album_id: we_got_it.id, ord: 5, audio: "http://s3.amazonaws.com/spitfire-dev/tracks/audios/000/000/362/original/ATribeCalledQuest_WeGotItFromHereThankYou4YourService_DisGeneration_5.mp3")
